...
export default function Surprise() {
  ...
  const surpriseText = "You are the best gift I could ever ask for. Thank you for being the amazing person you are";
  const text = "I alwayss Lovee youuuuuuuuuuuuuuuuuuuuu Myy Chinni Bangaramm";
